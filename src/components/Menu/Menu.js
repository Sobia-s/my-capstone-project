    ...
    return(
        <>
         ...
         <div className="dishes-container">
            <div className="dish">
               <img src={dish1} alt="greek salad" width={300} height={200} className="dish-img"/>
            ...
            <div>
            <div className="dish">
               <img src={dish2} alt="Bruschetta" width={300} height={200} className="dish-img"/>
               <div className="img-heading">
            ...
            <div>
            <div className="dish">
               <img src={dish3} alt="Lemon Dessert" width={300} height={200} className="dish-img"/>
               <div className="img-heading">
